...
export class AddSocioeconomicComponent implements OnInit, AfterViewInit {
  ...
  onSubmit() {
    ...
    else this.socioEconomicService.updateSocioEconomicDoc(this.socioEconomic);
  }
  ...
  addHomeService(service: string) {
    ...
    else this.openSnackBar("Ya agregó el servicio", "Ok", "red-snackbar");
  }
  ...
  addInstitutionHelp(i: any) {
    ...
    else this.openSnackBar("Ya agregó la institución", "Ok", "red-snackbar");
  }
