...
export class DataService {
  ...
  public mStatus = ["Soltera", "Casada", "Divorciada", "Viuda", "Relación"];
  public hearAboutWay = [
  ...
  public read = ["Sabe leer y escribir", "No sabe leer y escribir"];
  public education = [
  ...
  public childrenHelp = ["Pura Vida Missions ", "Beca escolar", "FSM", "Umbao"];
  ...
  public haveABusiness = ["Si / Yes", "No"];
  public socialSecurityType = [
    "Por el Estado / Government",
    "Voluntario  / Volunteer",
    "No"
  ];
  public takeMedication = ["Si / Yes", "No"];
  public alcoholProblems = ["Si / Yes", "No"];
  public drugsProblems = ["Si / Yes", "No"];
  public suicidalAttempt = ["Si / Yes", "No"];
  public suicidalThoughts = ["Si / Yes", "No"];
  constructor() {}
}
