...
export class HealthService {
  ...
  saveHealthDoc(doc: Health) {
    this._http.post(`${environment.SERVER_BASE_URL}api/health/saveHealthDoc`, doc).subscribe(
      success => {
        this.openSnackBar(
  ...
  updateHealthDoc(doc: Health) {
    this._http.put(`${environment.SERVER_BASE_URL}api/health/updateHealthDoc`, doc).subscribe(
      success => {
        this.openSnackBar(
  ...
  verifyExistency(PersonID: string) {
    this._http
      .get<Array<any>>(`${environment.SERVER_BASE_URL}api/health/verifyExistency/${PersonID}`)
      .subscribe(
        success => {
